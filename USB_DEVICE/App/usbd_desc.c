...
#define USBD_PRODUCT_STRING_HS     "STM32 Audio Class Apple Pie"
#define USBD_CONFIGURATION_STRING_HS     "AUDIO Config Apple Pie"
#define USBD_INTERFACE_STRING_HS     "AUDIO Interface Apple Pie"
