...
uint8_t *USBD_AUDIO_DeviceDescriptor          (USBD_Speed_t speed, uint16_t *length);
uint8_t *USBD_AUDIO_LangIDStrDescriptor       (USBD_Speed_t speed, uint16_t *length);
uint8_t *USBD_AUDIO_ManufacturerStrDescriptor (USBD_Speed_t speed, uint16_t *length);
uint8_t *USBD_AUDIO_ProductStrDescriptor      (USBD_Speed_t speed, uint16_t *length);
uint8_t *USBD_AUDIO_SerialStrDescriptor       (USBD_Speed_t speed, uint16_t *length);
uint8_t *USBD_AUDIO_ConfigStrDescriptor       (USBD_Speed_t speed, uint16_t *length);
uint8_t *USBD_AUDIO_InterfaceStrDescriptor    (USBD_Speed_t speed, uint16_t *length);
#ifdef USB_SUPPORT_USER_STRING_DESC
uint8_t *USBD_AUDIO_USRStringDesc(USBD_Speed_t speed, uint8_t idx, uint16_t *length);  
#endif /* USB_SUPPORT_USER_STRING_DESC */  

/* Private variables ---------------------------------------------------------*/
USBD_Descriptors_t AUDIO_Desc = {
